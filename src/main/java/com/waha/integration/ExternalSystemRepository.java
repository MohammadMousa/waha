...
public class ExternalSystemRepository {
    ...
    public Optional<ExternalSystem> findByName(String name) {
        List<ExternalSystem> rows = jdbc.query(
            "SELECT id, name, base_url, api_key, username, customer_override, enabled, " +
    ...
    public ExternalSystem upsert(String name, String baseUrl, String apiKey,
                                  String username, String customerOverride) {
        ...
        jdbc.update(
            "INSERT INTO external_systems (name, base_url, api_key, username, customer_override) " +
            "VALUES (:name, :baseUrl, :apiKey, :username, :customerOverride) " +
