...
// roleName       — highest-privilege role name for display (e.g. "SUPER_ADMIN", "ORGANIZATION_OWNER")
// permissions    — resolved permission names for this user at their current store
public record AuthResponse(String token, long userId, String username, Long storeId, Long defaultStoreId, String mode, Map<String, String> properties, String roleName, Set<String> permissions) {}
